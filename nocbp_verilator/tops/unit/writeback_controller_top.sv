...
module writeback_controller_top (
  ...
  writeback_controller #(
    ...
    ,.tx_notif_valid_o(tx_valid_o)
    ,.tx_notif_ready_i(tx_ready_i)
    ,.tx_notif_source_node_id_o(tx_source_node_id_o)
    ,.tx_notif_target_node_id_o(tx_target_node_id_o)
    ,.tx_notif_is_factor_o(tx_is_factor_o)
    ,.tx_notif_target_x_o(tx_target_x_o)
    ,.tx_notif_target_y_o(tx_target_y_o)
