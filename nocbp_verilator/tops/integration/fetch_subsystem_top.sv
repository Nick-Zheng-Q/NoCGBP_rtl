...
module fetch_subsystem_top #(
  ...
  pull_client u_pull_client (
    ...
    .tx_valid_o(tx_fetch_req_valid),
    .tx_ready_i(tx_fetch_req_ready),
    .tx_target_node_id_o(tx_fetch_req_target_node_id),
    .tx_consumer_node_id_o(tx_fetch_req_consumer_node_id),
    .tx_is_factor_o(tx_fetch_req_is_factor),
    .tx_target_x_o(tx_fetch_req_target_x),
    .tx_target_y_o(tx_fetch_req_target_y),
    .tx_txn_id_o(tx_fetch_req_txn_id),
    .tx_store_idx_o(tx_fetch_req_store_idx)
  );
  ...
  response_collector u_response_collector (
    .clk_i(clk),
    .rst_i(rst_i),
    .rx_valid_i(rx_fetch_resp_valid),
    .rx_ready_o(),
    .rx_is_factor_i(rx_fetch_resp_is_factor),
    .rx_state_words_i(rx_fetch_resp_state_words),
    .rx_data_i(rx_fetch_resp_data),
    .rx_data_valid_i(rx_fetch_resp_data_valid),
    .rx_last_i(rx_fetch_resp_last),
    .rx_done_valid_i(rx_fetch_resp_done_valid),
    .rx_txn_id_i(rx_fetch_resp_txn_id),
    .rx_node_id_i(rx_fetch_resp_node_id),
    .rx_consumer_node_id_i(rx_fetch_resp_consumer_node_id),
