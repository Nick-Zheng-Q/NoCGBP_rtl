...
module full_pull_cycle_top (
  ...
  writeback_controller u_pe_a_wb (
    ...
    ,.tx_notif_valid_o(pe_a_wb_tx_valid)
    ,.tx_notif_ready_i(pe_a_wb_tx_ready)
    ,.tx_notif_source_node_id_o(pe_a_wb_tx_source_node_id)
    ,.tx_notif_target_node_id_o(pe_a_wb_tx_target_node_id)
    ,.tx_notif_is_factor_o(pe_a_wb_tx_is_factor)
    ,.tx_notif_target_x_o(pe_a_wb_tx_target_x)
    ,.tx_notif_target_y_o(pe_a_wb_tx_target_y)
    ,.reset_valid_o()
    ,.reset_node_id_o()
    ,.reset_is_factor_o()
    ,.wb_done_o()
