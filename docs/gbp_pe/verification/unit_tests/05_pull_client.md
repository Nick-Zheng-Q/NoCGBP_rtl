...
| T+1   | req_target_pe | 0x02 | Target PE ID |
...
req       ___|        |_____________________________________
              ________
req_ready ____|        |_____________________________________
                  ________    ________
tx_valid  _______|        |__|        |______________________
                  ________    ________
tx_data   XXXXXXX| STORE1 |XX| STORE2 |XXXXXXXXXXXXXXXXXXXXXX
```
