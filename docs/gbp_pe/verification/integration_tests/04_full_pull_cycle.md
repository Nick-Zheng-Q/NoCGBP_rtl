...
|-------|-------------|-------|-------------|
| T+0   | compute_done_valid | 1 | Node N compute complete |
| T+0   | compute_done_node_id | 0x10 | Node N ID |
| T+0   | compute_done_is_factor | 0 | Variable node |
| T+1   | compute_done_valid | 0 | Clear |
...
| T+5   | rx_notif_target_node_id | 0x20 | Consumer node M |
| T+5   | rx_notif_source_pe | 0x00 | PE_A coordinates |
...
| T+7   | tx_fetch_req_consumer_node_id | 0x20 | Consumer node M |
| T+7   | tx_fetch_req_target_pe | 0x00 | Target PE_A |
...
| T+12  | rx_fetch_req_consumer_node_id | 0x20 | Consumer node M |
...
| T+25  | rx_fetch_resp_node_id | 0x10 | Producer node N |
...
| Cycle | PE_B Signal | Value | Description |
|-------|-------------|-------|-------------|
| T+30  | node_ready[20] | 1 | Node M ready (all edges done) |
| T+31  | sched_valid | 1 | Node M selected |
| T+31  | sched_node_id | 0x20 | Node M ID |
...
| T+1   | tx_notif_target_node_id | 0x20 | Consumer node M |
| T+1   | tx_notif_target_pe | 0x01 | Target PE_B |
...
| T+6   | fetch_req_consumer_node_id | 0x20 | Consumer node M |
...
| Cycle | PE_A Signal | Expected Value | Description |
|-------|-------------|----------------|-------------|
| T+18  | tx_fetch_resp_valid | 1 | Response metadata sent |
| T+18  | tx_fetch_resp_node_id | 0x10 | Producer node N |
| T+18  | tx_fetch_resp_state_words | 2 | Two state words |
| T+19  | tx_fetch_resp_valid | 1 | Data word 0 sent |
| T+19  | tx_fetch_resp_data | WORD_0 | First state word |
| T+19  | tx_fetch_resp_data_valid | 1 | Data valid |
| T+20  | tx_fetch_resp_valid | 1 | Data word 1 sent |
| T+20  | tx_fetch_resp_data | WORD_1 | Second state word |
| T+20  | tx_fetch_resp_data_valid | 1 | Data valid |
| T+20  | tx_fetch_resp_last | 1 | Last data word |
...
| T+28  | complete_producer_node_id | 0x10 | Producer node N |
| T+28  | complete_consumer_node_id | 0x20 | Consumer node M |
| T+29  | scoreboard_occupancy | 0 | Entry removed |
| T+30  | node_ready[20] | 1 | Node M ready |
| T+31  | accum_valid | 1 | Data fed to accumulator |
| T+31  | accum_data | WORD_0 | First state word |
| T+32  | accum_valid | 1 | More data |
| T+32  | accum_data | WORD_1 | Second state word |
| T+32  | accum_last | 1 | Last data word |
